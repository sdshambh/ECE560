...
//typedef enum {
//		W_FSM_IDLE = 0, 	// FSM completed, ready for new data
//		W_FSM_BUSY			 	// FSM busy
//	} W_Status;

//	extern W_Status * writeStatus;
extern int *status;
extern int *rstatus;
extern int *instatus;
typedef enum {S0,S1,S2,S3,S4,S5,S6,S7,S8,S9,S10,S11,S12,S13,S14} states ;
extern int idle_busy_status;
